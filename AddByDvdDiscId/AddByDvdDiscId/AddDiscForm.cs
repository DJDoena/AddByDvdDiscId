...
internal partial class AddDiscForm : Form
{
    ...
    private UI.IUIServices UIServices
    ...
    private DefaultValues DefaultValues
        => _serviceProvider.DefaultValues;

    public AddDiscForm(IServiceProvider serviceProvider
        , Locality locality
        , string profileId
        , string discId
        , IDriveInfo drive
        , IDVDInfo parentProfile
        , IEnumerable<IDVDInfo> profiles
        , string formattedDiscId)
    {
